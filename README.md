...
```bash
yarn add react-native-neteset-im-av2
```
...
b.去node_modules ➜ react-native-neteset-im-av2 ➜ ios ➜ 选择 RNNeteaseIm.xcodeproj
...
include ':react-native-neteset-im-av2'
project(':react-native-neteset-im-av2').projectDir = new File(settingsDir, '../node_modules/react-native-neteset-im-av2/android')
```
...
dependencies {
    ...
    compile project(':react-native-neteset-im-av2')
}
```
...
```
import {NimSession} from 'react-native-neteset-im-av2';
```
