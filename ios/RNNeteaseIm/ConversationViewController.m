...
-(NSMutableArray *)setTimeArr:(NSArray *)messageArr{
    ...
    for (NIMMessage *message in messageArr) {
        ...
        if (message.messageType == NIMMessageTypeText) {
            ...
            DWCustomAttachment *obj = (DWCustomAttachment *)customObject.attachment;
            if (obj) {
                switch (obj.custType) {
...
//发送自定义文本消息
-(void)sendCustomTextMessage:(nonnull  NSString *)digest extra:(NSString *)content{
    ...
    NIMMessage *message;
    DWCustomAttachment *obj = [[DWCustomAttachment alloc]init];
    obj.custType = CustomMessgeTypeCustom;
    obj.dataDict = dic;
    message = [NIMMessageMaker msgWithCustomAttachment:obj andeSession:_session];
