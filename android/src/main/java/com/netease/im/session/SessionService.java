...
//            message.setPushContent("有人@了你");
     ...
     * @param content
     */
    public void sendTextCustomMessage(String content, final String customData, OnSendMessageListener onSendMessageListener) {

        DefaultCustomAttachment msgAttachment = new DefaultCustomAttachment("diagnosis");
        msgAttachment.setContent(customData);
        msgAttachment.setDigst(content);
        IMMessage message = MessageBuilder.createCustomMessage(sessionId, sessionTypeEnum, content, msgAttachment);
        sendMessageSelf(message, onSendMessageListener, false);
    }
